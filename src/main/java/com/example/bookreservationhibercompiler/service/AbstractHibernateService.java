...
public abstract class AbstractHibernateService<Entity extends AbstractEntity, DTO extends AbstractDTO>
    ...
    @Transactional(readOnly = true)
    public List findAll() {
        return (List) toDTOs(getCurrentSession().createQuery("from " + clazzEntity.getName()).list());
    }
